...
Bu rehber, Nerzen Webmail projesini Ubuntu 22.04 tabanlı bir VDS sunucusuna en sağlıklı (Docker kullanarak) nasıl kuracağınızı adım adım anlatır.
...
```bash
cd /opt
sudo git clone <depo_adresiniz> nerzen-webmail
cd nerzen-webmail
```
